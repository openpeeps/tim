...
type
  Message* = enum
    ...
    varImmutable = "Attempt to reassign value to immutable variable $ [VarImmutable]"
    varImmutableValue = "Immutable variable $ requires initialization [VarImmutableValue]"
