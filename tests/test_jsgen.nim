...
proc runJS(code: string): string =
  let tmpFile = getTempDir() / "tim_test.js"
  writeFile(tmpFile, code)
  let sts = execCmdEx("node " & tmpFile)
  if sts.exitCode != 0:
    raise newException(CatchableError, "node exited with code " & $sts.exitCode & ": " & sts.output)
  sts.output.strip()

template checkOutput(transpiled, jsWrapper, expected: string) =
  let js = transpiled & "\n" & jsWrapper
  let output = runJS(js)
  check output == expected

suite "JSGen — Transpiler":
  test "simple variable and element":
    let code = transpile("""
var hello = "Tim Engine is Awesome!"
h1.fw-bold: $hello
""")
    checkOutput code, "console.log(HelloWorld.render());", """<h1 class="fw-bold">Tim Engine is Awesome!</h1>"""
...
div.container
  ...
  p: "Paragraph"
""")
    checkOutput code, "console.log(HelloWorld.render());", """<div class="container"><h1>Title</h1><p>Paragraph</p></div>"""

  test "nested elements":
    let code = transpile("""
div > div > span: "Deep"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<div><div><span>Deep</span></div></div>"
...
""")
    ...
    checkOutput code, "console.log(HelloWorld.render());", expected
...
if $flag == true:
  ...
  p: "No"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>Yes</p>"
...
if $flag == true:
  ...
  p: "No"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>No</p>"
...
ul
  for $item in $items:
    li: $item
""")
    checkOutput code, "console.log(HelloWorld.render());", "<ul><li>a</li><li>b</li><li>c</li></ul>"
...
while $i < 3:
  ...
  $i = $i + 1
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>0</p><p>1</p><p>2</p>"
...
p: "Hello, " & $name & "!"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>Hello, World!</p>"

  test "echo statement":
    let code = transpile("""
echo "hello world"
""")
    check code.contains("console.log(")
...
br
""")
    checkOutput code, "console.log(HelloWorld.render());", "<br>"
...
p: $x & " + " & $y & " = " & $x + $y
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>10 + 20 = 30</p>"
...
if $x > 3:
  p: "greater"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>greater</p>"
...
if $a == true and $b == false:
  p: "works"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>works</p>"
...
if $x == 1:
  ...
  p: "other"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>one</p>"

  test "string escaping":
    let code = transpile("""
p: "Line1\nLine2"
""")
    checkOutput code, "console.log(HelloWorld.render());", "<p>Line1\nLine2</p>"
